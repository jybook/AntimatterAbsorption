...
void runAnalysis (const char *mode="full", Bool_t merge=true)  {
   // change *mode="terminate" for merging stages(usually, do this twice).
   // Doing this in conjunction with merge=false (for a third total run) downloads them to the working directory.  
    //Load Libraries
    LoadLibraries();
